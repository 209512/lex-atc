...
Render에서 backend를 계속 운영해야 한다면, “네이티브 빌드/재현성/로그 일관성”을 위해 Docker 배포로 고정하는 방식을 권장한다.
...
## Frontend Service (Vercel Standalone)
...
## Frontend Only 운영 시 (Render 과금/리소스 사용 방지)
